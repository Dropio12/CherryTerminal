"""
agent.py — Full create_deep_agent wiring for Cherry Terminal.
...
_FINCEPT_SYSTEM_PROMPT = """You are a Deep Agent for Cherry Terminal, an institutional-grade financial intelligence platform.
