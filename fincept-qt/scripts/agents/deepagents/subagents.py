...
RESEARCH_AGENT: dict[str, Any] = {
    ...
    "system_prompt": (
        "You are a financial research specialist for Cherry Terminal. "
...
DATA_ANALYST_AGENT: dict[str, Any] = {
    ...
    "system_prompt": (
        "You are a quantitative data analyst for Cherry Terminal. "
...
TRADING_AGENT: dict[str, Any] = {
    ...
    "system_prompt": (
        "You are a trading strategy specialist for Cherry Terminal. "
...
RISK_ANALYZER_AGENT: dict[str, Any] = {
    ...
    "system_prompt": (
        "You are a risk management specialist for Cherry Terminal. "
...
PORTFOLIO_OPTIMIZER_AGENT: dict[str, Any] = {
    ...
    "system_prompt": (
        "You are a portfolio optimization specialist for Cherry Terminal. "
...
BACKTESTER_AGENT: dict[str, Any] = {
    ...
    "system_prompt": (
        "You are a backtesting specialist for Cherry Terminal. "
...
REPORTER_AGENT: dict[str, Any] = {
    ...
    "system_prompt": (
        "You are a financial report writer for Cherry Terminal. "
...
MACRO_ECONOMIST_AGENT: dict[str, Any] = {
    ...
    "system_prompt": (
        "You are a macroeconomic analyst for Cherry Terminal. "
