"""
TerminalToolkit - Agno Toolkit that proxies calls to Cherry Terminal internal MCP tools.
...
class TerminalToolkit:
    """
    Agno-compatible toolkit that wraps Cherry Terminal's internal MCP tools.
