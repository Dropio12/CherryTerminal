// installscript.qs -- Cherry Terminal QtIFW component script
//
// Handles:
...
Component.prototype.createOperations = function()
{
    ...
    if (systemInfo.kernelType === "winnt") {
        ...
        component.addOperation("CreateShortcut",
            ...
            "@StartMenuDir@/Cherry Terminal.lnk",
        ...
        component.addOperation("CreateShortcut",
            targetDir + "/FinceptTerminal.exe",
            "@DesktopDir@/Cherry Terminal.lnk",
            "workingDirectory=" + targetDir,
            "iconPath=" + targetDir + "/FinceptTerminal.exe",
            "iconId=0",
            "description=Professional Financial Intelligence Terminal");
    ...
    try {
        ...
        if (headless) {
            ...
            var answer = QMessageBox.question(
                ...
                "Remove Cherry Terminal User Data?",
                "Do you want to remove all Cherry Terminal user data?\n\n" +
                "This includes:\n" +
