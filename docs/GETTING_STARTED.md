# Getting Started with Cherry Terminal Development
## Your Complete Onboarding Guide

Welcome to Cherry Terminal! This guide will get you from zero to your first contribution.

---

## What is Cherry Terminal?

Cherry Terminal is an **open-source financial analysis platform** — a free, open-source alternative to legacy professional financial terminals. Version 4 is a native C++20 application built with Qt6.
...
> **Use exactly these versions.** Cherry Terminal's CMake build enforces them with `FATAL_ERROR` checks. Newer/older versions will refuse to configure.
...
**Expected Result:** Cherry Terminal window should open, showing the login screen.
